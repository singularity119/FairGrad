...
def main(path, lr, bs, device):
    ...
    if args.perturb_sigma > 0:
        ...
        # 【步骤 C】施加扰动
        logging.info(f"Applying perturbation with sigma={args.perturb_sigma}")
        with torch.no_grad():
...
if __name__ == "__main__":
    ...
    parser.add_argument("--perturb-sigma", type=float, default=0, help="Standard deviation of random noise for perturbation.")
    parser.add_argument("--noise-seed", type=int, default=None, help="Seed for the random noise perturbation.")
